...
namespace SpellGenerator.app
{
    ...
    public class AppCore
    {
        ...
        public List<ImageSize> imageSizes = new List<ImageSize>();
        ...
        public void Initialize()
        {
            ...
            imageSizes.Add(new ImageSize("竖向(普通)(832×1216)", 832, 1216));
            imageSizes.Add(new ImageSize("横向(普通)(1216×832)", 1216, 832));
            imageSizes.Add(new ImageSize("方形(普通)(1024×1024)", 1024, 1024));
            imageSizes.Add(new ImageSize("竖向(较大)(1024×1536)", 1024, 1536));
            imageSizes.Add(new ImageSize("横向(较大)(1536×1024)", 1536, 1024));
            imageSizes.Add(new ImageSize("方形(较大)(1472×1472)", 1472, 1472));
            imageSizes.Add(new ImageSize("竖向(壁纸)(1088×1920)", 1088, 1920));
            imageSizes.Add(new ImageSize("横向(壁纸)(1920×1088)", 1920, 1088));
            imageSizes.Add(new ImageSize("竖向(较小)(512×768)", 512, 768));
            imageSizes.Add(new ImageSize("横向(较小)(768×512)", 768, 512));
            imageSizes.Add(new ImageSize("方形(较小)(640×640)", 640, 640));
            imageSizes.Add(new ImageSize("自定义", 0, 0));
            ...
            else
            {
                foreach(var bconfig in systemConfig.backends)
                {
                    ...
                    else if (bconfig.engine == "Novel AI V3")
                    {
                        ge = new GENovalAI3();
                    }
                    else
        ...
        public void SaveSpell(string fileName)
        {
            try
            {
                string fileStr = GetSpellFileStr();
        ...
        void InitConfig()
        {
            ...
            genConfig.width = 1024;
            genConfig.height = 1024;
            genConfig.seed = -1;
            genConfig.samplingMethod = SamplingMethod.k_euler.webUIName;
            genConfig.samplingSteps = 28;
            genConfig.cfgScale = 5f;
            genConfig.denoisingStrength = 0.7f;
