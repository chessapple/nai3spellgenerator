...
namespace SpellGenerator.app
{
    public class SamplingMethod
    {
        ...
        public static SamplingMethod k_dpmpp_2s_a = new SamplingMethod("DPM++ 2S a", "k_dpmpp_2s_ancestral");
        public static SamplingMethod k_dpmpp_2m = new SamplingMethod("DPM++ 2M", "k_dpmpp_2m");
        public static SamplingMethod k_dpmpp_sde = new SamplingMethod("DPM++ 2M Sde", "k_dpmpp_sde");
        ...
        public static SamplingMethod ddim_v3 = new SamplingMethod("DDIM", "ddim v3");
